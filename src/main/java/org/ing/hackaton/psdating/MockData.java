...
public final class MockData {
    ...
    public static final Recommendation getMockData(final String companyName) {
        ...
        case "Albert Heijn Rotterdam":
            return Recommendation.builder().companyName(companyName).logoUrl("https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Albert_Heijn_Logo.svg/2000px-Albert_Heijn_Logo.svg.png").address("yep").zipCity("Rotterdam").phonenumber("010-1234567").build();
        }
        return null;
    }
}
